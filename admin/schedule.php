...
<body>
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-patient">
                        <a href="farmer.php" class="non-style-link-menu"><div><p class="menu-text">Farmers</p></a></div>
                    </td>
                </tr>
    ...
    if($_GET){
        ...
        if($action=='add-session'){
            ...
            $sqlmain12= "select * from appointment inner join farmer on farmer.pid=appointment.pid inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.scheduleid=$id;";
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label"><b>Farmers that Already registerd for this session:</b> ('.$result12->num_rows."/".$nop.')</label>
                                    <br><br>
                                </td>
                            </tr>

...
<body>
    ...
    $sqlmain= "select * from farmer where pemail=?";
                                    ...
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                                $sqlmain= "select * from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join farmer on farmer.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid  where  farmer.pid=$userid  and schedule.scheduledate>='$today' order by schedule.scheduledate asc";
                                                //echo $sqlmain;

...
if($_POST){
    ...
    if ($newpassword==$cpassword){
        ...
        if($result->num_rows==1){
            ...
            //TODO
            $database->query("insert into farmer(pemail,pname,ppassword, paddress,pdob,ptel) values('$email','$name','$newpassword','$address','$dob','$tele');");
...
?>
    ...
    <div class="container">
        <table border="0" style="width: 69%;">
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <input type="text" name="tele" class="input-text"  placeholder="ex: 01712345678">
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
